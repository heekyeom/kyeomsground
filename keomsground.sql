...
ALTER TABLE KG_SCHEDULE ADD CONSTRAINT IDX_KG_SCHEDULE_FK0 FOREIGN KEY (U_ID) REFERENCES KG_USER (U_ID) ON DELETE CASCADE;
ALTER TABLE KG_SCHEDULE ADD CONSTRAINT IDX_KG_SCHEDULE_FK1 FOREIGN KEY (R_NUM) REFERENCES KG_RESERVATION (R_NUM) ON DELETE CASCADE;
...
insert into KG_SCHEDULE values ('gg', 1);
insert into KG_SCHEDULE values ('ggg', 1);
insert into KG_SCHEDULE values ('gg', 2);
