					...
					<div class="col-md-10  card mx-auto">
						<form action="" method="post" id="fileForm" role="form">
							...
							<div class="form-group">
								<label for="username"><span class="req">* </span>예약자명:</label> <input
									class="form-control" type="text" name="username" id="txt"
									onkeyup="Validate(this)" placeholder="최소 6자리 이상 " required />

								<label for="username"><span class="req">* </span> 사용자
									초대: </label> <input class="form-control" type="text" name="username"
									id="txt" onkeyup="Validate(this)" placeholder="최소 6자리 이상 "
									required />
								<div id="errLast"></div>
							...
							<div class="form-group">
								<label for="firstname"><span class="req">* </span> 팀명 :
