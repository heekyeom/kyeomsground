...
<body>
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					...
					<c:choose>
						...
						<c:otherwise>
							<li class="nav-item"><a class="nav-link" href="#">대여확인</a>
							</li>
	...
	<c:choose>
		...
		<c:otherwise>
			<jsp:include page="regist.jsp"></jsp:include>
		</c:otherwise>
	</c:choose>
	...
	<footer class="py-5 bg-dark">
		<div class="container">
			<p class="m-0 text-center text-white">Copyright &copy; Kyeom Company 2018</p>
		</div>
		<!-- /.container -->
	</footer>
